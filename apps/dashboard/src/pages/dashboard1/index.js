...
const DashboardDefault = () => {
  ...
  // const handleChangeChargePoint = (e) => {
  //   setChargePointSelected(e);
  // };

  const handleRunMethod = () => {
    runMethod({ chargePointId: chargePoint, methodCall: method, params: form })
    .then((e)=>setResponse(JSON.stringify(e))
  );
  };
